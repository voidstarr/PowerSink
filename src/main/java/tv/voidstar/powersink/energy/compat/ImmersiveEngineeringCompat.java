...
public class ImmersiveEngineeringCompat {
    public static void removeEnergyAndPay(TileEntity tileEntity, UUID playerOwner) {
        Optional<Object> energyStorageOpt = EnergyCapability.getCapabilityInterface(tileEntity, EnergyType.IMMERSIVE_ENGINEERING);
        ...
        IFluxStorage energyStorage = (IFluxStorage) energyStorageOpt.get();
